...
Хост звонков необходим для нормального общения большого количества человек. Он занимается загрузкой и раздачей аудио. Общение с ним будет происходить по UDP. 

## Схема работы

Очевидно, что самыми тяжелыми таблица
