...
*Примечание: в приложении нет как таковых звонков. Есть условные каналы, куда могут подключиться до 50 человек одновременно и общаться.
...
Используя данные выше, посчитаем количество минут голосового общения в месяц:
    ...
    1,8 * 10^9 * 30 = 54 * 10^9 минуты/месяц
